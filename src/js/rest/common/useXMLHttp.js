...
export default (api, method, param, isGuest) => {
    let _makeRequestURL = (api, method, isGuest) => {
    ...
    let _setOverrideHeader = (xhr, method) => {
    ...
    let _send = (xhr, param, resolve, reject) => {
    ...
    let _getFile = (xhr, param, resolve, reject) => {
    ...
    let _postFile = (xhr, param, resolve, reject) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        let url = _makeRequestURL(api, method, isGuest)
        if (!url) {
            reject(errors.useSetDomain)
        } else {
            xhr.open('POST', url, true)
            let isNeededCSRFToken = _setHeaders(xhr, api, method)
